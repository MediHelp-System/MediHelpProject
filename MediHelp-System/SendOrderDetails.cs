...
{
    public partial class SendOrderDetails : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT OrderID,ParmacyID,CustomerName,Age,CustomerAddress,CustomerContactNo FROM SendOrderDetails", sqlCon);
        ...
        private void SendOrderDetails_Load(object sender, EventArgs e)
        {
            this.Hide();
            Login lg = new Login();
            lg.Show();
